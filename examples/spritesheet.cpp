...
int main() {
    WindowManager::get()->createWindow({800, 600}, {400, 300}, "SpectrumLib example [spritesheet]", false, WindowFlags::Default | WindowFlags::Resizable | WindowFlags::ScaleToMonitor);
